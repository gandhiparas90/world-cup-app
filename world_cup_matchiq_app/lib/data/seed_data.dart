...
class SeedData {
  ...
  static const teams = <Team>[
    ...
    Team(
      ...
      code: 'POR',
      flagLabel: 'POR',
      group: 'Qualified team',
      manager: 'Roberto Martinez',
      style: 'Technical possession, wide overloads, late midfield runs',
      formSummary:
          'Included in the local catalog for fan personalization; no match appears in today\'s fixture snapshot.',
      teamNews:
          'Portugal profile is static starter data until live team-news feeds are connected.',
      attackRating: 83,
      defenseRating: 78,
      formPoints: 10,
      avgGoalsFor: 1.9,
  ...
  static const players = <Player>[
    ...
    Player(
      ...
      position: 'Forward',
      news: 'Fan watchlist scorer profile in the static Portugal catalog.',
      goalThreatRating: 82,
      recentGoals: 3,
      recentAssists: 1,
      likelyStarter: true,
    ...
    Player(
      ...
      position: 'Midfielder',
      news: 'Creative hub and penalty-area chance creator for Portugal.',
      goalThreatRating: 78,
      recentGoals: 2,
      recentAssists: 4,
      likelyStarter: true,
